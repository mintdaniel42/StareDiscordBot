...
public enum CommandList {
	...
	public CommandData get() {
		return switch (this) {
			case user -> Commands.slash("user", R.Strings.ui("user_related_commands"))
					.addSubcommands(
			...
			case hns -> Commands.slash("hns", R.Strings.ui("hide_n_seek_related_commands"))
					.addSubcommands(
			...
			case pg -> Commands.slash("pg", R.Strings.ui("partygames_related_commands"))
					.addSubcommands(
							...
							new SubcommandData("list", R.Strings.ui("list_partygames_entries"))
									.addOption(OptionType.INTEGER, "page", R.Strings.ui("page"), false, true));
			case group -> Commands.slash("group", R.Strings.ui("group_related_commands"))
			...
			case maintenance -> Commands.slash("maintenance", R.Strings.ui("control_maintenance"))
					.addOption(OptionType.BOOLEAN, "active", R.Strings.ui("if_maintenance_should_be_enabled"), true)
					.setDefaultPermissions(DefaultMemberPermissions.enabledFor(Permission.ADMINISTRATOR));
			case approve -> Commands.slash("approve", R.Strings.ui("approve_a_change"))
