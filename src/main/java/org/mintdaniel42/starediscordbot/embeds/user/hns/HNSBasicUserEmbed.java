...
public class HNSBasicUserEmbed {
	...
	public @NonNull MessageEmbed of(@NonNull final HNSUserEntity hnsUser, @NonNull final UserEntity user, @NonNull final UsernameEntity username, final boolean isRequest) {
