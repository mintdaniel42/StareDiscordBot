...
public class GroupEmbed {
	public @NonNull MessageEmbed of(@NonNull final GroupEntity group, @NonNull final UserRepository userRepository, @NonNull final HNSUserRepository hnsUserRepository, @NonNull final UsernameRepository usernameRepository) {
		return of(group, userRepository, hnsUserRepository, usernameRepository, 0, false);
	}

	public @NonNull MessageEmbed of(@NonNull final GroupEntity group, @NonNull final UserRepository userRepository, @NonNull final HNSUserRepository hnsUserRepository, @NonNull final UsernameRepository usernameRepository, final boolean isRequest) {
		return of(group, userRepository, hnsUserRepository, usernameRepository, 0, isRequest);
	}

	public @NonNull MessageEmbed of(@NonNull final GroupEntity group, @NonNull final UserRepository userRepository, @NonNull final HNSUserRepository hnsUserRepository, @NonNull final UsernameRepository usernameRepository, final int page, final boolean isRequest) {
		final var builder = new EmbedBuilder()
				...
				.addField(R.Strings.ui("group_leader"), MCHelper.getUsername(usernameRepository, group.getLeader()), false)
